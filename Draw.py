...
class TriangleCommand:
    ...
    def __str__(self):
        return '<Command radius="' + str(self.radius) + '" width="' + \
               str(self.width) + '" color="' + self.color + '">Triangle</Command>'
...
class DrawingApplication(tkinter.Frame):
    ...
    def buildWindow(self):
        ...
        def parse(filename):
            ...
            for commandElement in graphicsCommands:
                ...
                if command == "GoTo":
                    ...
                    width = int(attr["width"].value)
                    color = attr["color"].value.strip()
                    cmd = TriangleCommand(radius,width,color)                    
        ...
        def triangleHandler():
            cmd = TriangleCommand(int(radiusSize.get()),int(widthSize.get()), penColor.get())
            cmd.draw(theTurtle)
            self.graphicsCommands.append(cmd)
        ...
        trianlgeButton = tkinter.Button(sideBar, text = "Draw Triangle", command=triangleHandler)
        trianlgeButton.pack(fill=tkinter.BOTH)
